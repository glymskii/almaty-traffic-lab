...
describe("compileNetwork on the mini fixture", () => {
  ...
  it("marks provenance and groups assumptions", () => {
    ...
    // The "stage not implemented" notice (overrides; city is wired since T-27, transit is wired
    // but silent when the bbox has no transit data at all) plus the dead-lane diagnostic of the
    // intersections stage: the left pocket of w100_0_f has no left exit because the cross street
    // is one-way. The footway and the service road are ignored silently.
