...
| 4. Поздние стадии | `stages.ts` | `intersections` (T-07, реализована), `signals` (T-08, реализована), `transit` (T-17, реализована), `city` (T-27), `overrides` (T-24): вызываются, если задача заполнила `run`, иначе пропуск с предупреждением |
